...
namespace Data_Access_Layer
{
    public class DALMission
    {
        ...
        {
            return _cIDbContext.Missions.Where(m => !m.IsDeleted)
                .ToList();
        }
        ...
        public string AddMission(Missions mission)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("End date not acceptable!");
            ...
            try
            {
                ...
                if (!missionExists)
                {
                    ...
                    if (missionToUpdate != null)
                    {
                        ...
                        if (mission.StartDate > mission.EndDate)
                        {
                            //result = "End date not acceptable";
                            throw new Exception("End date not acceptable!");
                        }
                        else
                        {
                        ...
                        throw new Exception("Update Mission Detail Successfully.");
                        }
                    }
                    else
                    {
